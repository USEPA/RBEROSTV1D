...
Open the R project file: Tier_1_Optimization-SSWR_5_3_2.Rproj
...
Two RMarkdown files are provided to support optimizations.  To run optimizations for a single watershed, click on RunRBEROST-Northeast-Dynamic.Rmd to start.  To run optimizations for multiple watersheds, click on RunRBEROST-Northeast-Dynamic_Batch.Rmd to start.
